...
// intersection 
let nameValue: { key: number } & { value: string } = { key: 0, value: "" };
nameValue.key = 1;
...
let entry: NameValuePair = { key: 1, value: "foo" };
// entry = { id: 6 }; 
...
class ManipulatorManager implements IManipulatorManager {
    ...
    // cache that holds letious manipulators 
...
let mgr: IManipulatorManager = new ManipulatorManager();
